 ...
 *
 * ```kotlin
 * package com.lalilu.knr.generated
 *
 ...
 *
 * /**
 *  * This class is generated by KNR, do not modify it.
 * */
 * private class `KNRMap_Metadata_1986967826` {
 ...
 * 专门用于收集路由信息的处理器
 */
open class KNRCollectProcessor(
    ...
    companion object {
        const val GENERATED_SHARED_PACKAGE = "com.lalilu.knr.generated"
        const val CLASS_KDOC = "This class is generated by KNR, do not modify it."
    }
    ...
    private fun writeToFile(
        ...
        val className = "KNRMap_Metadata_${Random.nextInt().absoluteValue}"
